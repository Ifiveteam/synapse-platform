...
현재 `app/repositories/`는 비어 있고, 구현이 분산되어 있다.

| 위치 | 역할 |
|------|------|
| `agents/indexer/repository.py` | `VideoVector` CRUD, 중복 검사 |
...
| `archiver/` | Archiver LangGraph | [docs/archiver](../archiver/README.md) |
...
- Profiler — [docs/profile/IMPLEMENTATION.md](../profile/IMPLEMENTATION.md)
...
| 문서 | 내용 |
|------|------|
| [profile/IMPLEMENTATION.md](../profile/IMPLEMENTATION.md) | Profiler 레이어·파이프라인 |
